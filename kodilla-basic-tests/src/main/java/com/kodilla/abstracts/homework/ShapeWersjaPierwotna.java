...
public abstract class ShapeWersjaPierwotna { //tworzę klasę abstrakcyjną Shape -> z tej klasy będą dziedziczyły inne klasy
    ...
    public ShapeWersjaPierwotna(double surfaceArea, double circuit){  // tworzymy konstruktor.
